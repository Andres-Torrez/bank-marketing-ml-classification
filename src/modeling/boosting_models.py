...
def get_boosting_models() -> Dict[str, Any]:
    """
    Return boosting candidate models.
    """
    return {
...
def evaluate_on_test(model_pipeline: Pipeline, X_test, y_test) -> Dict[str, Any]:
    ...
    if hasattr(model_pipeline, "predict_proba"):
        ...
        # HistGradientBoostingClassifier does not expose predict_proba in some wrappers consistently
...
def main() -> None:
    ...
    candidate_models = get_boosting_models()
    ...
    summary_path = METRICS_DIR / "boosting_models_summary.json"
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump(all_results, f, indent=4)

    print("Boosting model training and evaluation completed.")
